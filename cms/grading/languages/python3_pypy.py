...
class Python3PyPy(CompiledLanguage):
    ...
    precisely, the subversion of Python 3 made available by the PyPy
    interpreter on the system, usually 3.5).
    ...
    def get_compilation_commands(self,
        ...
        for idx, source_filename in enumerate(source_filenames):
            commands.append(["/usr/bin/pypy3", "-m", "py_compile", source_filename])
