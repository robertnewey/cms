...
LANGUAGE_TO_TIME_LIMIT_MAP = {
    LANG_C: COMPILED,
    LANG_CPP: COMPILED,
    LANG_CS: HALF_COMPILED,
    LANG_PASCAL: COMPILED,
    LANG_PYTHON2: INTERPRETED,
    LANG_PYTHON3: INTERPRETED,
    LANG_PHP: INTERPRETED,
    LANG_JAVA: HALF_COMPILED
}
